...
@media(max-width:900px){.page{width:calc(100% - 20px);margin:10px;padding:20px;overflow:visible}.cover-grid{grid-template-columns:1fr}.groups{grid-template-columns:1fr}.player-header{align-items:flex-start;gap:12px;flex-direction:column}.summary{flex-wrap:wrap}footer{position:static;margin-top:20px}.toolbar{gap:10px}.toolbar button{padding:8px}}
